...
<head>
    ...
    <title>{{isset($title) ? $title : 'Amaal Academy'}}</title>
            ...
            <div class="bookmark-wrapper d-flex align-items-center">
                ...
                <ul class="nav navbar-nav bookmark-icons">
                    <li class="nav-item d-none d-lg-block">
                        <a class="nav-link" target="_blank" href="https://amaalacademy.com" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{trans('common.websiteHome')}}">

...
//         $html .= '<br><a href="https://amaalacademy.com" dir="rtl" style="padding:10px 20px;font-size:16px;text-align:center;">اضغط هنا لتسجيل الدخول</a>';
//         $html .= '</div>';
//         return $html;
//     } else {
//         $html = '<div dir="rtl" style="padding-top:30px;font-size:16px;text-align:center;">';
//         $html .= 'your account activated successfully';
//         $html .= '<br><a href="https://amaalacademy.com" dir="rtl" style="padding:10px 20px;font-size:16px;text-align:center;">click here to login</a>';
//         $html .= '</div>';
//         return $html;
//     }

...
class StaticPagesController extends Controller
{
    ...
    public function settings(Request $request)
    {
        ...
        $list = [
            ...
            'about_data' => [
                'title_ar' => getSettingValue('title_ar'),
                'title_en' => getSettingValue('title_en'),
                'des_ar' => getSettingValue('des_ar'),
                'des_en' => getSettingValue('des_en'),
                'photo' => getSettingValue('photo'),
